export const news = {
  ...
  DUPLICATES: [
    {
      ID: 260855434,
      TI: 'UK banking apps at risk: 47% lack antivirus on phones',
      AB: '',
      URL: 'https://securityexample.com/uk-banking-app-risk',
      DP: '2025-03-06T22:15:00',
      DOM: 'securityexample.com',
      SENT: 'negative',
      LANG: 'en',
      AU: ['John Doe'],
      FAV: '/favicons/sample-favicon1.png',
      KW: [],
      HIGHLIGHTS: [],
      REACH: 1500,
      CNTR: 'United Kingdom',
    ...
    {
      ID: 260855435,
      TI: 'New Kaspersky report on smartphone banking security',
      AB: '',
      URL: 'https://technews.com/kaspersky-report-mobile-banking',
      DP: '2025-03-06T23:45:00',
      DOM: 'technews.com',
      SENT: 'neutral',
      LANG: 'en',
      AU: ['Alice Smith'],
      FAV: '/favicons/sample-favicon2.png',
      KW: [],
      HIGHLIGHTS: [],
      REACH: 980,
      CNTR: 'Germany',
